...
const ListOfDentistId = () => {
  ...
  useEffect(() => {
    axios
      ...
      .then((resp) => {
        const filteredData = resp.data.items.filter(
          (item) => item.id === id
        );
    ...
    axios
      .get('/api/UserProfileImage/merchant-banner', {
        params: {
          merchantid: id,
        },
        ...(token && {
      ...
      .then((res) => {
        if (res.data?.success && res.data?.base64Image) {
          setBanner(res.data.base64Image);
        }
      })
      .catch((err) => {
        console.error(err);
          ...
          >
            ...
            <div className="md:col-span-7 col-span-12">
              <div className="flex-col md:flex-row text-center md:text-right flex items-center gap-4 mb-20">
                <div className="w-48 h-48 rounded-full p-2 border border-border-color overflow-hidden">
                  <img
              ...
              <div>
                ...
                <p className="font-normal text-[#757575] text-[16px] mb-10 text-justify">
                  ...
                  است، چاپگره ا و متون بلکه روزنامه و مجله در ستون و سطرآنچنان لازم است، و برای شرایط فعلی 
                  تکنولوژی مورد نیاز و کاربرد های متنوع با هدف بهبود ابزارهای کاربردی می باشد، کتابهای زیادی در
                  شصت.لورم ایپسوم متن  ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان
                  گرافیک است، چاپگرها و متونبلکه روزنامه و مجله در ستون و سطرآنچنان لازم است، و برای شرایط
                  فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارها کاربردی می باشد.
                </p>
                <div className="flex flex-col md:flex-row items-center gap-2 mb-10">
                  <Image src='/assets/icons/health.svg' alt="health"  width={32} height={32}/>
                 <div className="flex items-center gap-1">
                   <p className="font-normal text-[#757575] text-[16px]">تخصص پزشکی :</p>
                  <p className="font-normal text-primary text-[16px]">{item.professionalTitle}</p>
                 </div>
                </div>
            ...
            <div className="md:col-span-5 col-span-12 mb-10 md:mb-0">
              ...
              <div className="flex items-center gap-4">
                <p className="font-normal text-[#414141] text-[20px]">
                  تلفن :
                </p>
                <p className="font-normal text-[#757575] text-[16px]">
                  ۰۲۱-۳۸۷۳۶۲ | ۰۲۱-۶۲۵۳۵
                </p>
              </div>
            </div>
          </div>
